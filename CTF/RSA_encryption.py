...
def rsa_verify(public_key, message, signature):
    """Verify a signed message using the RSA public key."""
    decrypted_signature = rsa_decrypt(public_key, signature)
...
signature_message = rsa_sign(private_key, message)
print("Signature of the message:", signature_message)

is_verified = rsa_verify(public_key, message, signature_message)
